...
public class PanelItem extends javax.swing.JPanel {
    ...
    public static Color myClr1 = new Color(102, 102, 102);

    /**
     * Creates new form PanelItemNew
     */
    public PanelItem() {
        // super(parent, modal);
        initComponents();
        ...
        tblItem.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                txtItemCode.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 0).toString());
                txtType.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 1).toString());
                txtBrand.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 2).toString());
                txtColour.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 3).toString());
                txtDescription.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 4).toString());
                txtBuyingPrice.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 5).toString());
                txtSellingPrice.setText(tblItem.getValueAt(tblItem.getSelectedRow(), 6).toString());
                spnrQtyOnHand.setValue(tblItem.getValueAt((Integer) tblItem.getSelectedRow(), 7));
    ...
    public void getID() {
        String newID;
        try {
            newID = IDGenarator.getNewID("Item", "i_code", "I");
     ...
     * regenerated by the Form Editor.s d
     */
    ...
    private void initComponents() {
        ...
        spnrQtyOnHand = new javax.swing.JSpinner();
        ...
        txtBuyingPrice = new org.jdesktop.swingx.JXTextField();
        txtSellingPrice = new org.jdesktop.swingx.JXTextField();
        getICode = new javax.swing.JButton();
        ...
        pnlItem.setBackground(new java.awt.Color(153, 153, 153));
        pnlItem.setName(""); // NOI18N
        ...
        btnAdd.setText("Add");
        btnAdd.setToolTipText("Click to add item");
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/sareecenter/iconsS/Wedding Dress_40px_1.png"))); // NOI18N
        jLabel8.setText(" ");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(btnAdd, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        spnrQtyOnHand.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        btnCancel.setToolTipText("Click to clear all");
        ...
        txtBuyingPrice.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        txtBuyingPrice.setPrompt("Buying Price");
        ...
        getICode.setBackground(new java.awt.Color(204, 204, 204));
        getICode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/ijse/sareecenter/iconsS/Spinner Frame 2_20px.png"))); // NOI18N
        getICode.setToolTipText("Click to get Item Code");
        getICode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                getICodeActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtColour, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(txtItemCode, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(spnrQtyOnHand, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(18, 18, 18)
                .addComponent(getICode, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35))
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(getICode, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(38, 38, 38)
                        ...
                        .addGap(34, 34, 34)
                        .addComponent(txtColour, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35)
                        .addComponent(txtDescription, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(39, 39, 39)
                        .addComponent(txtBuyingPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(spnrQtyOnHand, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel12.setText("View All Item");
        ...
        tblItem.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Code", "Type", "Brand", "Colour", "Description", "Buying Price", "Selling Price", "Qty On Hand"
            }
        ));
        tblItem.setEditable(false);
        tblItem.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        tblItem.setGridColor(new java.awt.Color(0, 153, 153));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(pnlItem, javax.swing.GroupLayout.PREFERRED_SIZE, 749, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ItemDTO item = new ItemDTO(
                ...
                (Integer) spnrQtyOnHand.getValue()
        );
        ...
        try {
            ...
            if (result) {
                ...
                JOptionPane.showMessageDialog(this, "Item hasn't been deleted");
            }
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            ...
            if (result) {
                ...
                JOptionPane.showMessageDialog(this, "Item hasn't been added");
            }
        } catch (Exception ex) {
            Logger.getLogger(PanelItem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            if (result) {
                ...
                JOptionPane.showMessageDialog(this, "Item hasn't been updated");
            }
    ...
    private void txtSellingPriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSellingPriceActionPerformed
        spnrQtyOnHand.setValue(1);
    }//GEN-LAST:event_txtSellingPriceActionPerformed

    private void jPanel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseEntered
        getICode.requestFocus();
    }//GEN-LAST:event_jPanel1MouseEntered

    private void getICodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getICodeActionPerformed
        getID();
        txtType.requestFocus();
    }//GEN-LAST:event_getICodeActionPerformed
    ...
    private javax.swing.JButton getICode;
    ...
    private javax.swing.JSpinner spnrQtyOnHand;
    private org.jdesktop.swingx.JXTable tblItem;
    private org.jdesktop.swingx.JXTextField txtBrand;
    private org.jdesktop.swingx.JXTextField txtBuyingPrice;
    private org.jdesktop.swingx.JXTextField txtColour;
    private org.jdesktop.swingx.JXTextField txtDescription;
    private org.jdesktop.swingx.JXTextField txtItemCode;
    private org.jdesktop.swingx.JXTextField txtSellingPrice;
    private org.jdesktop.swingx.JXTextField txtType;
